...
//		});
	...
	public void onClick(View v){
		...
		case R.id.print_img_btn:
        	...
        	//sendMessage(PicFromPrintUtils.compressPic(GetLocalOrNetBitmap("https://sp0.baidu.com/5aU_bSa9KgQFm2e88IuM_a/micxp1.duapp.com/qr.php?value=http%3A%2F%2Fwww.zgbang.com.cn%2Fdownload%2Fv2.0%2Fzgbang.apk")));
	...
	public  Bitmap GetLocalOrNetBitmap(String url) {
		...
		try
		{
			in = new BufferedInputStream(new URL(url).openStream(), 360);
			final ByteArrayOutputStream dataStream = new ByteArrayOutputStream();
			out = new BufferedOutputStream(dataStream,360);
			out.flush();
